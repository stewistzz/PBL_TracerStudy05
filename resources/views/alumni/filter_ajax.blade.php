<form id="filterForm">
    ...
    <div class="mb-3">
        ...
        <input type="number" class="form-control" id="filter_tahun_lulus_start" name="tahun_lulus_start" placeholder="Contoh: 2010">
    </div>
    <div class="mb-3">
        <label for="filter_tahun_lulus_end" class="form-label">Tahun Lulus (Sampai)</label>
        <input type="number" class="form-control" id="filter_tahun_lulus_end" name="tahun_lulus_end" placeholder="Contoh: 2025">
    </div>
