<div class="modal-header">
    <h5 class="modal-title" id="filterModalLabel">Filter Data Jawaban Alumni</h5>
    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
</div>
<div class="modal-body">
    <form id="filterForm" method="GET" action="{{ route('jawaban_alumni.list') }}">
        <div class="mb-3">
            <label for="pertanyaan_id" class="form-label">Pertanyaan (Khusus Alumni)</label>
            <select class="form-select" id="pertanyaan_id" name="pertanyaan_id" style="max-width: 100%; overflow-x: auto; white-space: normal;">
                <option value="">Semua Pertanyaan Alumni</option>
            </select>
        </div>
        <div class="mb-3">
